...
// Sat, Jul 18, 2026 • 5:00 PM EDT → 21:00 UTC
const THIRD_PLACE_FIXTURES = [
  {
    home: "France",
    away: "England",
...
async function main() {
  ...
  console.log(
    dryRun
      ? "🧪 Dry run: Third Place fixture import (no writes)"
      : "🛠️ Importing Third Place fixtures...",
  );
  ...
  for (const fixture of THIRD_PLACE_FIXTURES) {
